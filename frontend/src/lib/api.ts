...
const API_BASE = process.env.NEXT_PUBLIC_API_URL ?? "http://localhost:8044";
...
export interface ClassifyResponse {
  ...
  extra?: { confidence?: number; ml_prediction?: number; [key: string]: unknown } | null;
}
